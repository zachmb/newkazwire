		...
		<main class="flex flex-col gap-6">
			{#if gameData}
				...
				{#if showShareModal}
					...
					>
						<div
							class="w-full max-w-2xl rounded-3xl bg-white p-8 text-center shadow-2xl"
							...
							tabindex="-1"
						>
							<h3 class="mb-4 text-2xl font-black text-neutral">Share this AI Game!</h3>
					...
					<div class="flex flex-col justify-between gap-6 md:flex-row md:items-center">
						<div class="flex items-center gap-4">
							...
							<div>
								...
								<p class="flex items-center gap-1 text-sm font-bold text-neutral/40">
									Generated by <span class="text-primary">Froggy AI</span>
								</p>
							</div>
						</div>
			...
			{:else}
				<div
					class="flex h-[60vh] flex-col items-center justify-center gap-6 rounded-3xl bg-white text-center shadow-sm"
				>
