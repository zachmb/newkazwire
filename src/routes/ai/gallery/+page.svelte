...
<div class="font-sans min-h-screen bg-[#5B9BFF] p-4 text-neutral">
	<div class="mx-auto grid max-w-[1800px] grid-cols-1 gap-6 lg:grid-cols-[1fr_5fr_2fr]">
		...
		<main class="flex flex-col gap-6">
			<div
				class="flex flex-col items-center justify-between gap-4 rounded-3xl bg-white p-8 shadow-xl md:flex-row"
			>
				<div class="flex items-center gap-4">
					<div
						class="flex h-16 w-16 items-center justify-center rounded-2xl bg-accent text-neutral shadow-lg"
					>
			...
			<div class="min-h-[400px] rounded-3xl bg-white p-6 shadow-xl">
				{#if isLoading}
