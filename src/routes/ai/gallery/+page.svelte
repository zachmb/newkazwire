...
<div class="font-sans min-h-screen bg-base-200 p-4 text-base-content">
	<div class="mx-auto grid max-w-[1800px] grid-cols-1 gap-6 lg:grid-cols-[240px_minmax(0,1fr)]">
		...
		<main class="flex flex-col gap-6">
			...
			<!-- Join the craze — a full-width banner so the game cards below can use the
			     entire width (previously a right sidebar that left dead space beneath it). -->
			<div class="flex items-center gap-4 rounded-box border border-base-content/10 bg-base-100 p-5 shadow-sm">
				<div class="grid h-11 w-11 flex-none place-items-center rounded-xl bg-primary/10 text-primary">
					<Icon icon="mdi:trending-up" class="text-2xl" />
				</div>
				<div>
					<h3 class="font-black tracking-tight">Join the craze</h3>
					<p class="text-sm opacity-70">
						Millions of games are being generated by AI — remix a popular one to add your own twist.
					</p>
				</div>
			</div>
